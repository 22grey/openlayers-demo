...
var FeatureHerald = (function (Herald) {
  ...
  FeatureHerald.prototype.activate = function activate () {
    ...
    this.featureListener_ = new Listener(this.feature_.on('change', function () { return this$1.handleFeatureChange_(); }));

    this.listener = new PropertyListener(this.feature_, null, this.feature_.getGeometryName(), function (geometry, oldGeometry) {
      if (oldGeometry) {
   ...
   * @private
   */
  FeatureHerald.prototype.handleFeatureChange_ = function handleFeatureChange_ () {
    this.updateStyle_();
  };
   ...
   * @private
   */
  FeatureHerald.prototype.updateStyle_ = function updateStyle_ () {

    // override style if a style is defined at the feature level
    var mapIconOptions = {useCanvas: this.feature_.useCanvas || this.mapIconOptions_.useCanvas};
    ...
    if (style) {
      var latLng = createLatLng(getCenterOf(this.getGeometry_()));
