...
var ViewHerald = (function (Herald) {
  ...
  ViewHerald.prototype.activate = function activate () {
    ...
    this.listener = new PropertyListener(this.ol3map, null, 'view', function (view, oldView) {
      ...
      return new Listener([
        ...
        view.on('change:resolution', function () { return this$1.setZoomAndCenter(); }),
   ...
   */
  ViewHerald.prototype.setZoomAndCenter = function setZoomAndCenter () {
    var resolution = this.ol3map.getView().getResolution();
    if (typeof resolution === 'number') {
      var zoom = getZoomFromResolution(resolution, this.ol3map.getView().getMinZoom());
